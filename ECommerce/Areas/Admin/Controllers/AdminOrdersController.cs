...
namespace ECommerce.Areas.Admin.Controllers
{
    public class AdminOrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,UserAddressID,StatusID,TotalProductPrice,TotalTaxPrice,TotalDiscountPrice,TotalPrice,CreateDate,UpdadateDate,CreateUserID,UpdateUserID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,UserAddressID,StatusID,TotalProductPrice,TotalTaxPrice,TotalDiscountPrice,TotalPrice,CreateDate,UpdadateDate,CreateUserID,UpdateUserID")] Order order)
        {
            if (ModelState.IsValid)
            {
